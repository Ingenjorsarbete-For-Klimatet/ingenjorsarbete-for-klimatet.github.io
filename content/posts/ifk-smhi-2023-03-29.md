...
har modifierats från originalartikeln på [mladen.gibanica.net](https://mladen.gibanica.net/posts/ifk-smhi).
...
Observera attde tre senaste månaderna vanligtvis saknas från `"corrected-archive"`.
...
mm finns tillgängligt på [SMHIs API-sida](https://opendata.smhi.se/apidocs/metanalys/parameters.html)
men en intressant parameter ute i skärgården är förstås vindhastighet - för att
läsa ut byvindhastigheter timme för timme tar vi då:
