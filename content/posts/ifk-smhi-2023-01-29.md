...
<iframe id="igraph" alt="Historisk data över snödjup i Kiruna, från SMHI" scrolling="no" style="border:none;" seamless="seamless" src="{{post_url}}/data/kiruna_snodjup.html" height="525" width="100%"></iframe>
